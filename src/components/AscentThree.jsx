...
export default function AscentThree() {
  return (
    <section className="w-full max-w-4xl mx-auto px-6 py-24 text-white">
      <motion.div
        ...
        className="space-y-6"
      >
        <h2 className="text-sm uppercase tracking-widest text-slate-400">↟ Ascent III</h2>
        <h3 className="text-lg font-semibold text-slate-200">Senior Engineer - Modeling & Simulation, BAE Systems (2018–2022)</h3>
        ...
        <ClimbButton target="#ascent-4" label="Climb Higher" />

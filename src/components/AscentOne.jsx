...
export default function AscentOne() {
  return (
    <section className="w-full max-w-4xl mx-auto px-6 py-24 text-white">
      <motion.div
        ...
        className="space-y-6"
      >
        <h2 className="text-sm uppercase tracking-widest text-slate-400">↟ Ascent I</h2>
        <h3 className="text-lg font-semibold text-slate-200">Engineer I - Systems Engineer, BAE Systems (2016–2018)</h3>
        ...
        <ClimbButton target="#ascent-2" label="Climb Higher" />
